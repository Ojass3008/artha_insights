// Vercel cron — pulls RSS from a small set of Indian finance/startup sources,
// classifies each item by pillar, dedupes by URL, and writes to Supabase.
    ...
    for (const feed of FEEDS) {
      try {
        ...
        for (const it of list.slice(0, 15)) {
          ...
          const excerpt =
            stripHtml(it.description) || stripHtml(it.summary) || null
